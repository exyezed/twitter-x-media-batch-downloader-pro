...
u(
                "select",
                {
                  ...
                  children: [
u("option", { value: "all", children: t("All") }),
u("option", { value: "image", children: t("Image") }),
u("option", { value: "video", children: t("Video") }),
u("option", { value: "gif", children: t("GIF") }),
u("option", { value: "text", children: t("Text") })
                  ]
                }
              )
            ] }),
...
u(IconPlayerStop, { size: 16 }),
                    ...
                    const fetchKey = mediaType.value === "all" ? "Fetch All" : mediaType.value === "video" ? "Fetch Video" : mediaType.value === "image" ? "Fetch Image" : mediaType.value === "gif" ? "Fetch GIF" : mediaType.value === "text" ? "Fetch Text" : "Fetch";
                    return u(preact.Fragment, { children: [
...
u("div", { class: "tooltip", "data-tip": `${t("All")} (${account.timeline.length.toLocaleString()})`, children: u(
            ...
            photoCount > 0 && u("div", { class: "tooltip", "data-tip": `${t("Image")} (${photoCount.toLocaleString()})`, children: u(
              "button",
              {
            ...
            videoCount > 0 && u("div", { class: "tooltip", "data-tip": `${t("Video")} (${videoCount.toLocaleString()})`, children: u(
              "button",
              {
            ...
            gifCount > 0 && u("div", { class: "tooltip", "data-tip": `${t("GIF")} (${gifCount.toLocaleString()})`, children: u(
              "button",
              {
...
u(
                      ...
                      item.type === "animated_gif" && u("div", { class: "absolute inset-0 flex items-center justify-center bg-black/30", children: u(IconGif, { size: 16, class: "text-white" }) })
                    ]
                  }
                ) : u(
                  "div",
...
u("div", { class: "card bg-base-200 border border-base-300 w-full", children: [
u("div", { class: "card-body p-4", children: u("div", { class: "flex items-center gap-4", children: [
...
u("div", { class: "flex gap-2 mt-1", children: [
                  account.media_type && u("div", { class: "badge badge-soft badge-primary badge-sm", children: account.media_type === "all" ? t("All") : account.media_type === "image" ? t("Image") : account.media_type === "video" ? t("Video") : account.media_type === "gif" ? t("GIF") : account.media_type === "text" ? t("Text") : t("All") }),
...
u("div", { class: "dropdown dropdown-end", children: [
u("div", { tabIndex: 0, role: "button", class: "btn btn-sm btn-square btn-ghost", "aria-label": t("More options"), children: u(IconDots, { size: 16 }) }),
u("ul", { tabIndex: 0, class: "dropdown-content menu bg-base-200 rounded-box z-1 w-48 p-2 shadow-lg border border-base-300", children: [
u("li", { children: u(
                      "button",
                      {
                        onClick: async () => {
